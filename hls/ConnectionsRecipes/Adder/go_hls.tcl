...
options set Input/CompilerFlags "-D_SYNTHESIS_ -DSC_INCLUDE_DYNAMIC_PROCESSES -DCONNECTIONS_ACCURATE_SIM $HLS_CATAPULT_FLAG -DRAND_SEED=$env(SEED) -DCONN_RAND_STALL"
go analyze
