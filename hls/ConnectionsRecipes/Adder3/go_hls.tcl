...
proc nvhls::set_input_files {SRC_PATH TOP_NAME SYSC} {
    solution file add [list $SRC_PATH/$TOP_NAME/$TOP_NAME.h] -type SYSTEMC
    solution file add [list $SRC_PATH/Adder3/testbench.cpp] -type SYSTEMC -exclude true
}
