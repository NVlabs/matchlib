...
set TB_FILES [list ../../../cmod/examples/ConnectionsRecipes/Adder3/testbench.cpp]

options set Input/SearchPath ". ../../../cmod ../../../cmod/include ../../../cmod/examples/ConnectionsRecipes/$TOP_NAME $env(RAPIDJSON_HOME)/include"
...
options set Input/CompilerFlags "-D_SYNTHESIS_ -DSC_INCLUDE_DYNAMIC_PROCESSES -DCONNECTIONS_ACCURATE_SIM $HLS_CATAPULT_FLAG"
go analyze
