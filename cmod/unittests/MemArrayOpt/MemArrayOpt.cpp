...
void MemArrayOpt(MemWord_t write_data, MemWord_t & read_data, NVUINT1 mem_op, MemAddr_t addr) {
  static const int kDebugLevel = 1;
  static mem_array_opt <MemWord_t, NUM_ENTRIES, NBANKS> banks;
  BankSel_t bank_sel;
