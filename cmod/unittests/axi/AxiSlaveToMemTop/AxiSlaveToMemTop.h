 ...
 */
#ifndef AXI_SLAVE_TO_MEM_TOP_H
#define AXI_SLAVE_TO_MEM_TOP_H

#include <systemc.h>
#include <ac_reset_signal_is.h>
#include <axi/axi4_configs.h>

#include <axi/AxiSlaveToMem.h>

class AxiSlaveToMemTop : public sc_module {
 public:
  ...
  SC_HAS_PROCESS(AxiSlaveToMemTop);

  AxiSlaveToMemTop(sc_module_name name)
      : sc_module(name),
        clk("clk"),
        reset_bar("reset_bar"),
        axi_read("axi_read"),
