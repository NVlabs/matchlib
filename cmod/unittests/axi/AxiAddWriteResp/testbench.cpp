...
SC_MODULE(testbench) {
  ...
  typename axi::axi4<cfgNoWresp>::read::template chan<> axi_read_m;
  typename axi::axi4<cfgNoWresp>::write::template chan<> axi_write_m;
  typename axi::axi4<cfgWithWresp>::read::template chan<> axi_read_s;
