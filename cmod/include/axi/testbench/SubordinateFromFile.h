...
#ifndef __AXI_T_SUBORDINATE_FROM_FILE__
#define __AXI_T_SUBORDINATE_FROM_FILE__
...
/**
 * \brief An AXI subordinate with its memory prepopulated from a file for use in testbenches.
 * \ingroup AXI
 *
 ...
 *
 */
template <typename axiCfg> class SubordinateFromFile : public sc_module {
 public:
