 ...
 protected:
  ...
  class NNode<A, 0> {
   public:
    A data0;
    NNode() {}
    NNode(sc_module_name nm) : data0(ccs_concat(nm, "0")) {}
    NNode(sc_module_name nm, const unsigned& id)
        : data0(ccs_concat(nm, "0"), 0) {}
  ...
  class NNode<A, 1> {
   public:
    ...
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")), data1(ccs_concat(nm, "1")) {}
    NNode(sc_module_name nm, const unsigned& id)
        : data0(ccs_concat(nm, "0"), 0), data1(ccs_concat(nm, "1"), 1) {}
    A& Get(unsigned int idx) {
      if (idx == 0)
        return data0;
      else if (idx == 1)
  ...
  class NNode<A, 2> {
   public:
    ...
    NNode() {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")) {}
    NNode(sc_module_name nm, const unsigned& id)
        : data0(ccs_concat(nm, "0"), 0),
          data1(ccs_concat(nm, "1"), 1),
          data2(ccs_concat(nm, "2"), 2) {}
    A& Get(unsigned int idx) {
      if (idx == 0)
        return data0;
      else if (idx == 1)
   ...
   public:
    ...
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
          data3(ccs_concat(nm, "3")) {}
    NNode(sc_module_name nm, const unsigned& id)
        : data0(ccs_concat(nm, "0"), 0),
          data1(ccs_concat(nm, "1"), 1),
          data2(ccs_concat(nm, "2"), 2),
          data3(ccs_concat(nm, "3"), 3) {}
    A& Get(unsigned int idx) {
      if (idx == 0)
        return data0;
      else if (idx == 1)
   ...
   public:
    ...
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          ...
          data2(ccs_concat(nm, "2")),
          data3(ccs_concat(nm, "3")),
          data4(ccs_concat(nm, "4")) {}
    NNode(sc_module_name nm, const unsigned& id)
        : data0(ccs_concat(nm, "0"), 0),
          data1(ccs_concat(nm, "1"), 1),
          data2(ccs_concat(nm, "2"), 2),
          data3(ccs_concat(nm, "3"), 3),
          data4(ccs_concat(nm, "4"), 4) {}
    A& Get(unsigned int idx) {
      if (idx == 0)
        return data0;
      else if (idx == 1)
  ...
  class NNode<p2p<>::in<A>, 0> {
   public:
    p2p<>::in<A> data0;
    NNode() : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")) {}
    NNode(sc_module_name nm) : data0(ccs_concat(nm, "0")) {}
  ...
  class NNode<p2p<>::in<A>, 1> {
   public:
    ...
    p2p<>::in<A> data1;
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          data1(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "1")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")), data1(ccs_concat(nm, "1")) {}
    p2p<>::in<A>& Get(unsigned int idx) {
      if (idx == 0)
  ...
  class NNode<p2p<>::in<A>, 2> {
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          data1(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "1")),
          data2(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "2")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")) {}
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          data1(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "1")),
          data2(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "2")),
          data3(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "3")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data2(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "2")),
          data3(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "3")),
          data4(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "4")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data3(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "3")),
          data4(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "4")),
          data5(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "5")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data4(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "4")),
          data5(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "5")),
          data6(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "6")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data5(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "5")),
          data6(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "6")),
          data7(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "7")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data6(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "6")),
          data7(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "7")),
          data8(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "8")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data7(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "7")),
          data8(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "8")),
          data9(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "9")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data8(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "8")),
          data9(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "9")),
          data10(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "10")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data9(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "9")),
          data10(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "10")),
          data11(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "11")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data10(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "10")),
          data11(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "11")),
          data12(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "12")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data11(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "11")),
          data12(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "12")),
          data13(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "13")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data12(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "12")),
          data13(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "13")),
          data14(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "14")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data13(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "13")),
          data14(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "14")),
          data15(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "15")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data14(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "14")),
          data15(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "15")),
          data16(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "16")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data15(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "15")),
          data16(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "16")),
          data17(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "17")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data16(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "16")),
          data17(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "17")),
          data18(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "18")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data17(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "17")),
          data18(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "18")),
          data19(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "19")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data18(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "18")),
          data19(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "19")),
          data20(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "20")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data19(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "19")),
          data20(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "20")),
          data21(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "21")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data20(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "20")),
          data21(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "21")),
          data22(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "22")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data21(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "21")),
          data22(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "22")),
          data23(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "23")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data22(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "22")),
          data23(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "23")),
          data24(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "24")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data23(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "23")),
          data24(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "24")),
          data25(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "25")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data24(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "24")),
          data25(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "25")),
          data26(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "26")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data25(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "25")),
          data26(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "26")),
          data27(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "27")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data26(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "26")),
          data27(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "27")),
          data28(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "28")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data27(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "27")),
          data28(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "28")),
          data29(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "29")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data28(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "28")),
          data29(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "29")),
          data30(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "30")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
   ...
   public:
    ...
    NNode()
        : data0(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "0")),
          ...
          data29(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "29")),
          data30(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "30")),
          data31(ccs_concat(sc_gen_unique_name("BOOST_PP_EMPTY"), "31")) {}
    NNode(sc_module_name nm)
        : data0(ccs_concat(nm, "0")),
          data1(ccs_concat(nm, "1")),
          data2(ccs_concat(nm, "2")),
