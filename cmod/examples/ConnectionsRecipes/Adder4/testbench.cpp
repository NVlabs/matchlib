...
#define NVHLS_VERIFY_BLOCKS (Adder4)
...
SC_MODULE (Source) {
    Connections::Out<Adder4::Data> x_out;
...
SC_MODULE (Dest) {
    Connections::In<Adder4::Data> sum_in;
...
SC_MODULE (testbench) {
    NVHLS_DESIGN(Adder4) adder;
    Source srca,srcb;
    Dest dest;

    Connections::Combinational<Adder4::Data> a,b,sum;
